      ...
      <div className="px-8 py-16">
        <div className="max-w-3xl mx-auto text-center mb-8">
          ...
          <p className="text-xl text-[#8888A0] mb-6">
            We compare your resume against live market job requirements and show exactly what's missing.
          </p>
          ...
          <div className="rounded-2xl bg-[rgba(255,255,255,0.03)] backdrop-blur-[12px] border border-[#1E1E2E] p-8">
            <div className="mb-8">
              ...
              <div className="relative group">
                <div className="rounded-xl border-2 border-dashed border-[#1E1E2E] bg-[#0A0A0F] p-12 text-center hover:border-[#4F8EF7] hover:shadow-[0_0_24px_rgba(79,142,247,0.15)] transition-all duration-200">
            ...
            <button className="w-full py-4 rounded-lg bg-gradient-to-r from-[#4F8EF7] to-[#7C5CFC] text-[#F0F0F5] hover:shadow-[0_0_32px_rgba(79,142,247,0.3)] hover:scale-[0.98] active:scale-[0.96] transition-all duration-200 animate-pulse">
              Analyze My Resume →
            </button>
          </div>
        </div>
